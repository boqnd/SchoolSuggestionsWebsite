...
<form action="process.php" method="POST">
    ...
    <h1>FEG Suggest</h1>
            ...
            <hr>
            <label for="suggestion" id="errLabel">* Предложение: </label><br/><textarea rows="7" name="suggestion" id="suggestionErr" class="textBox" placeholder="Напишете своето предложеие тук. (ЗАДЪЛЖИТЕЛНО ПОЛЕ)" ></textarea>
